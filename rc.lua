...
globalkeys = gears.table.join(
   ...
   --Move focused client to screen end
    ...
    --Move focused client to previous tag and switch to it
    ...
    --Move focused client to previous tag and switch to it end

    
    --Move focused client to next tag and switch to it
    ...
    --Move focused client to next tag and switch to it end


    --Display brightness binding
    awful.key({ }, "XF86MonBrightnessDown", function ()
        awful.util.spawn("xbacklight -dec 15") end),
    awful.key({ }, "XF86MonBrightnessUp", function ()
        awful.util.spawn("xbacklight -inc 15") end),
    --Display brightness binding end


    --Volume binding
    awful.key({}, "XF86AudioRaiseVolume", function()
        awful.util.spawn("pactl set-sink-volume @DEFAULT_SINK@ +1000") end),
...
--start the polybar
awful.spawn.with_shell("~/.config/desktopsetup/polybar/launchpolybar.sh")
--compton is the compositor
